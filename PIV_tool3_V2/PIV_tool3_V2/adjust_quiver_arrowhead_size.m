...
%     errordlg('Input "quivergroup_handle" is not of type "hggroup".', mfilename);
%     return
% end
...
%     return
% end
set(quivergroup_handle,'AutoScaleFactor',scaling_factor)
set(quivergroup_handle,'MaxHeadSize',scaling_factor*2)
